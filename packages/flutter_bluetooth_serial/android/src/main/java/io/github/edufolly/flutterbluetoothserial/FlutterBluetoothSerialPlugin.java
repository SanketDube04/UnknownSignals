        ...
        stateChannel.setStreamHandler(new StreamHandler() {
            ...
            public void onListen(Object o, EventSink eventSink) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= 33) {
                    activeContext.registerReceiver(stateReceiver, new IntentFilter(BluetoothAdapter.ACTION_STATE_CHANGED), Context.RECEIVER_EXPORTED);
                } else {
        ...
        public void onMethodCall(MethodCall call, Result result) {
            ...
            switch (call.method) {
                ...
                case "bondDevice": {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 33) {
                        activeContext.registerReceiver(bondStateBroadcastReceiver, filter, Context.RECEIVER_EXPORTED);
                    } else {
                ...
                case "pairingRequestHandlingEnable":
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 33) {
                        activeContext.registerReceiver(pairingRequestReceiver, filter, Context.RECEIVER_EXPORTED);
                    } else {
                ...
                case "startDiscovery":
                    ensurePermissions(granted -> {
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= 33) {
                            activeContext.registerReceiver(discoveryReceiver, intent, Context.RECEIVER_EXPORTED);
                        } else {
